-- =====================================================================================
--  Datos de prueba del microservicio `matchpoint`.
--
...
--
--  Estan sembrados a proposito los casos que disparan CADA validacion de negocio:
--    - cancha 3 inactiva            -> POST /reservations  = 409
--    - cancha 4 de otro MANAGER     -> PATCH /courts/4      = 403 (propiedad)
--    - reserva 1 ocupa una franja   -> misma franja         = 409 (solapamiento)
--    - reserva 4 de otro PLAYER     -> DELETE /reservations/4 = 403 (propiedad)
--    - torneo 1 con 3 de 4 equipos  -> POST /tournaments/1/start = 409 (cupo incompleto)
--    - torneo 2 con 2 de 2 equipos  -> POST /tournaments/2/start = 200 (arranca)
--    - torneo 3 ya FINISHED         -> inscribir equipo     = 409 (inscripcion cerrada)
--    - torneo 4 de otro MANAGER     -> start                = 403 (propiedad)
-- =====================================================================================
...
-- Campeon del torneo ya terminado (FK diferida a teams).
...
-- --------------------------------------------------------------- reservations -------
-- owner_name es una COPIA de lo que devolvio el microservicio users por HTTP.
...
-- Que las secuencias sigan despues de los ids sembrados a mano.
